        ...
        <div class="_flexbox">
            ...
            <div class="container">
                ...
                <form method="get" action="profile.html">
                    ...
                    <input type="text" id="first-name" placeholder="James" />

                    <label for="last-name">Last Name</label>
                    <input type="text" id="last-name" placeholder="Wilson" />
                    
                    <label for="mission-area">Mission</label>
                    <select name="mission-area" id="mission-area"> 
                        ...
                        <option value="Tennessee Knoxville Mission" selected="selected">Tennessee Knoxville Mission</option>
                    ...
                    <input type="date" id="start-date" value="2024-06-03"/>

                    <label for="end-date">End Date</label>
                    <input type="date" id="end-date" value="2026-06-03"/>
                    
                    <label for="phone-number">Phone Number</label>
                    <input type="tel" id="phone-number" placeholder="720 492 4200"/>

                    <div class="radio-flex">
                        <label for="elder">Elder</label>
                        <input type="radio" id="elder" name="gender" value="elder" checked="checked" />

                        <label for="sister">Sister</label>
                        <input type="radio" id="sister" name="gender" value="sister" />
                    </div>
                    <br />

                    <label for="username">Username</label>
                    <input type="text" id="username" placeholder="j1m03"/>

                    <label for="password">Password</label>
                    <input type="text" id="password" placeholder="bdubs******!"/>

                    <button type="submit" class="accent-button">Update Profile</button>
                </form>
                <a href="home.html" class="accent-link">Don't Save Changes</a>
            </div>
        </div>
    </div>
    </main>
